...
class HeatModelInputs(BaseModel):
    ...
    co2_lbs_per_kwh: float                # Pounds of CO2 per incremental kWh generated by Utility for the heat pump.
    garage_stall_count: int               # 0: No garage, 1: 1-car garage.  Max is 4.
    garage_heated_by_hp: bool = False            # True if garage is heated by heat pump.
    ...
    pct_exposed_to_hp: float              # fraction of the home that is open to the Heat Pump Indoor units (no doorway separating)
