...
class HSPFtype(str, Enum):
    hspf = 'hspf'
    hspf2_reg4 = 'hspf2_reg4'
    hspf2_reg5 = 'hspf2_reg5'

'''
class HeatModelInputs(BaseModel):
    city_id: int                  # ID of City being modeled
    hp_hspf: float                # HSPF rating of heat pump being modeled
    hspf_type: HSPFtype           # Type of HSPF given
    exist_heat_fuel_id: int      # ID of fuel used in existing heating system being offset.
